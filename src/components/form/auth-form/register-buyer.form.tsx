...
import { useRegisterUserBuyer } from "../../../hooks/auth-hooks/register-buyer.hook";
import { ApiResponse } from "../../../store/auth-store/types/response.type";
import { useApplicationStore } from "../../../store/store";
import { colorPallete } from "../../../styles/color";
import { useForm } from "react-hook-form";
import {
	REGISTER_BUYER_DEFAULT_VALUES,
	REGISTER_BUYER_VALIDATION_SCHEMA,
} from "../../../utils/constants/auth.constants";

export type RegisterBuyerFormValues = {
	name: string;
	surname: string;
	email: string;
	phone: string;
...
export const RegisterForm = () => {
	...
	const {
		...
		handleSubmit,
		formState: { errors },
	} = useForm<RegisterBuyerFormValues>({
		defaultValues: REGISTER_BUYER_DEFAULT_VALUES,
		resolver: yupResolver(REGISTER_BUYER_VALIDATION_SCHEMA),
	});
	const { registerUserBuyer } = useRegisterUserBuyer();
	...
	async function handleRegister(values: RegisterBuyerFormValues) {
		await registerUserBuyer(values).then((res: ApiResponse<null>) => {
