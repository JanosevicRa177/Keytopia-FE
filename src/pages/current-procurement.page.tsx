		...
		<MainContrainer>
			<Flex w={"100%"} flexDirection={"column"} my={"32px"} position={"relative"}>
				<Flex
					...
					zIndex={1}
				/>
				<Flex justifyContent={"space-between"} px={"32px"} mb={"24px"}>
							...
							<Flex gap={"24px"}>
								<Flex alignItems={"center"} gap={"12px"}>
									<Img
										...
										rounded={"4px"}
										cursor={"pointer"}
										onClick={() => decreaseQuantityToPartProcurement(part.name)}
									/>
									<NumberInput
										...
										onChange={(e) => {
											if (e === "NaN") return;
											setQuantityToPartProcurement(part.name, parseInt(e));
										}}
										ref={ref}
									>
										<NumberInputField />
									...
									<Img
										...
										rounded={"4px"}
										cursor={"pointer"}
										onClick={() => increaseQuantityToPartProcurement(part.name)}
									/>
								</Flex>
