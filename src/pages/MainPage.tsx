        ...
        >
          <Box mt={"25px"}>
            ...
            <Text fontSize={"xl"} textAlign={"justify"}>
              ...
              parts. From keycaps and switches to plates and stabilizers, we
              offer a wide range of components to cater to your customization
              desires. Our carefully curated selection features trusted brands
              and exclusive collaborations, ensuring you'll find the perfect
      ...
      <SectionContainer style={SectionStyle.left}>
        ...
        >
          <Box mt={"25px"}>
            ...
            <Text fontSize={"xl"} textAlign={"justify"}>
              Explore our selection of prebuilt custom keyboards. Each keyboard
              is expertly crafted with precision and attention to detail,
              ensuring a seamless typing experience right out of the box. Choose
              from a variety of stunning designs and layouts, all carefully
              selected to deliver exceptional performance and style.
            </Text>
            <Flex justifyContent={"center"} mt={"24px"}>
              <Button
                w={"250px"}
      ...
      <SectionContainer style={SectionStyle.left}>
        ...
        >
          <Box mt={"50px"}>
            ...
            <Text fontSize={"xl"} textAlign={"justify"}>
              Where your keyboard dreams become a reality. Get ready to embark
              on a personalized typing adventure like no other. Start exploring
              our vast selection, unleash your creativity, and elevate your
              typing experience to new heights. We're honored to have you as
              part of our community, and we can't wait to see the masterpiece
              you'll create!
            </Text>
          </Box>
        </Flex>
